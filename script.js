...
const studentInformation = {
    ...
    graduationYear: "2024",
    imageUrl: "https://static.wikia.nocookie.net/earthbound/images/c/c1/Lucas_sprite.png/revision/latest?cb=20190309014706",
}
...
function addCourseRowToReportCard(reportCardTableElement, course, rowNum) {
    ...
    <h4 class="pts-col">${course.gpaPointsLookup}</h4>
    </div>
    `
}
...
function updateReportCard(reportCardTableElement, currentSemester) {
    ...
    addCourseRowToReportCard(reportCardTableElement, currentSemester, currentSemester.length);
}
...
window.onload = function () {
    ...
    updateReportCard("#report-card-table", studentData["Spring Semester"])
}